...
if($sczzbh1==''){
    echo "<script>alert('请选择印件名称！');location.href='../newpiece.php?ddh=$bh&mxid=$mxid'</script>";
    exit;
}
$pname = mysql_result(mysql_query("select zzmc from base_zz_ck where scbh = '$sczzbh1'",$connykgf),0,'zzmc');
