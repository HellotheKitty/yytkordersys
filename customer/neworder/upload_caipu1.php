            ...
            <tr>
              ...
              <table width="100%" border="1" align="center" cellspacing="0" cellpadding="0" style="border-width:0px;border-collapse:collapse;border:1px solid #D3D3D3; border-bottom:1px solid #D3D3D3; font-size:12px">
                <tr>
                  ...
                  <td colspan="3"><input name="file1" type="text" id="file1" placeholder="填写完整的文件名，如test.pdf" size=25 value="<? echo $file1?>" />
                  <!--<? if ($state=="新建") {?><a href="javascript:void(0)" onclick="javascript:window.open('<? echo $localftp?>/fileup.php?mxid=3&lx=file','OrderDetail4','height=300px,width=400px,top=100px,left=100px,location=no,menubar=no,resizable=no,scrollbars=yes,status=no,titlebar=no,toolbar=no,directories=no');return false;"  class="a1">上传</a><? }?>--></td>
                </tr>
                <tr>
...
<option value="纵向">
              ...
              <input type="hidden" name="n2" value="<? echo $n2?>" />
                <table width="100%" border="1" align="center" cellspacing="0" cellpadding="0" style="border-width:0px;border-collapse:collapse;border:1px solid #D3D3D3; border-bottom:1px solid #D3D3D3; font-size:12px">
                  ...
                  <td width="10%" class="tstyle1">文件上传</td>
                  <td colspan="3"><input name="file2" type="text" id="file2" placeholder="填写完整的文件名，如test.pdf" size=25  value="<? echo $file2?>"/>
                   <!--<? if ($state=="新建") {?><a href="javascript:void(0)" onclick="javascript:window.open('<? echo $localftp?>/fileup.php?mxid=4&lx=file','OrderDetail4','height=300px,width=400px,top=100px,left=100px,location=no,menubar=no,resizable=no,scrollbars=yes,status=no,titlebar=no,toolbar=no,directories=no');return false;"  class="a1">上传</a><? }?>--></td>
                </tr>
                <tr>
                  <td class="tstyle1">机器/颜色</td>
    ...
    <table cellspacing="0" cellpadding="0" rules="all" border="1" id="gvOrder" style="border-width:0px;width:100%;border-collapse:collapse;border:1px solid #D3D3D3; border-bottom:1px solid #D3D3D3; font-size:12px">
	  <tbody><tr class="td_title" style="height:30px;">
        ...
        <tr class="td_title" style="height:30px;">
			...
			if ($state=="新建") {?> 
            <a href='?deleid=<? echo mysql_result($rsmx,$i,"id");?>&ddh=<? echo $bh;?>&mxsid=<? echo $id?>'>[删除]</a>
			<? }
			?>
            </td>
...
提示：制作文件请发送给客服，确保发送给客服的文件名和以上填写的文件名一致，务必填写包含扩展名(如.pdf)的完整的文件名。
</body>
