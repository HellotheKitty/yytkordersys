...
function logout(){
	if(!confirm('<? echo $_SESSION["KHMC"];?> 您确定要退出吗？')){
		return false;
	}
	else {
...
<div class="page">		
	<div class="topline">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--<iframe width="400" scrolling="no" height="22" frameborder="0" allowtransparency="true" src="http://i.tianqi.com/index.php?c=code&id=1&color=%23FFFFFF&bgc=%23&py=<?// echo $_SESSION["GSSDQ"]=="上海"?"shanghai":"beijing";?>&icon=1&wind=1&num=1"></iframe>-->
		<div id="seehello">
			<ul>
				...
				<li class="welcome"><? echo $_SESSION["KHMC"];?></li>
				<li class="welcome">
					<a href="javascript:void(0)" onclick="javascript:window.open('commonfunc/changepwd.php?user=<? echo $_SESSION['KHMC']  ?>&from=list','OrderDetail','height=400px,width=700px,top=100px,left=1000px,location=no,menubar=no,resizable=no,scrollbars=yes,status=no,titlebar=no,toolbar=no,directories=no');return false;"  class="logout">修改密码</a>
				</li>
			</ul>
		</div>
    </div>
	...
	<div class="navright">
		<marquee direction="left" width="800" scrollamount="3" onmouseover=this.stop() onmouseout=this.start() >
		<span id="mqs"></span>
		</marquee>
	</div>
