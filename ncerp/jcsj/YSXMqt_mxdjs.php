            ...
            <td height="222" valign="top">
                <table width="95%" height="153" border="0" align="center">
                    <tr>
                        ...
                        <td width="394" align="right" class="STYLE13">&nbsp;<input type="hidden" name="id" value="<? echo $id?>" /><input type="hidden" name="ddh" id="ddh" value="<? echo $bh?>" /></td>
                    </tr>
...
-->
                                        ...
                                        <td colspan="3"><select name="paper1" id="paper1" onchange="setjg(1)" >
                                                ...
                                                if(substr($dwdm,0,2) == '34'){
                                                    ...
                                                    $rs2=mysql_query("select materialcode,materialname,specs from material where zzfy='3301' order by id");
                                                }
                                                if($rs2)
