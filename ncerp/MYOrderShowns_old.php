...
<? }
    ...
    if ($_SESSION["FBCW"] == 1 || $_SESSION['FBSD'] == 1) {
        ...
        订单状态：<select name="gp" onchange="form1.submit();">
            ...
            <option value="进入生产" <? if ($gp == '进入生产') echo "selected"; ?> >打印生产中</option>
            <option value="已打印" <? if ($gp == '已打印') echo "selected"; ?> >后加工中</option>
                            ...
                            <? for ($i = 0; $i < mysql_num_rows($rs); $i++) {
                                ...
                                <tr class="td_title" style="height:30px;"
                                    ...
                                    <td>
                                        ...
                                        if(mysql_result($rs,$i,'state') == '已打印'){

                                            echo '后加工中';

                                        }elseif(mysql_result($rs,$i,'state') == '进入生产'){
                                            echo '打印生产中';
                                        }else{
                                            echo  mysql_result($rs, $i, "state");
                                        }
