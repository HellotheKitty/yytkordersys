...
if (jQuery) (function($) {
    ...
    $.extend($.fn, {
        menuTree: function(o, callback) {
            ...
            if (o.expandSpeed == undefined) o.expandSpeed = 400;
            if (o.collapseSpeed == undefined) o.collapseSpeed = 400;
...
if ($(this).parent().hasClass('parent1')) {
                            if ($(this).parent().hasClass('expanded')) {
                                ...
                                if (!o.multiOpenedSubMenu) {
                                    $(this).parent().parent().find('UL').slideUp({ duration: o.collapseSpeed, easing: o.collapseEasing });
                                    $(this).parent().parent().find('LI.parent1').removeClass('expanded').addClass('collapsed');
                                }
                                $($(this).parent().find("UL")[0]).slideDown({ duration: o.expandSpeed, easing: o.expandEasing });
                                $(this).parent().removeClass('collapsed').addClass('expanded');
                                $(this).parent().find('LI.parent1').removeClass('expanded').addClass('collapsed');
