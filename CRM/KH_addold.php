...
下次联系：<input name="xclx" type="text" value="3" style="width:30px">天后。 【<a href='void(0)' onclick='javascript:lxxx.xclx.value="1";return false;'>1天</a>；<a href='void(0)' onclick='javascript:lxxx.xclx.value="3";return false;'>3天</a>；<a href='void(0)' onclick='javascript:lxxx.xclx.value="7";return false;'>7天</a>；<a href='void(0)' onclick='javascript:lxxx.xclx.value="15";return false;'>15天</a>；<a href='void(0)' onclick='javascript:lxxx.xclx.value="30";return false;'>30天</a>；<a href='void(0)' onclick='javascript:lxxx.xclx.value="180";return false;'>180天</a>】
<br>
...
<input name="zxx" type="button" value="无法联系" title="无法联系退回数据收集" onClick="if (confirm('确认无法联系吗？电话是空号或者电话错误情况。')) {$.post('KH_saveinfo.php?lx=diuqi', $('#lxxx').serialize(),function(data){alert('Data Loaded: ' + data);});CloseDiv('MyDiv','fade');}">
<? if ($state==-1) {?>
