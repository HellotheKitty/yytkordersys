...
//总条数
$restotal = mysql_query("select count(*) rowcount , sum(order_mainqt.dje) zdje from order_mainqt where order_mainqt.ddate>='$d1 00:00:00' and order_mainqt.ddate<='$d2 23:59:59' and order_mainqt.khmc like '%{$d3}%' and locate('$d4',order_mainqt.ddh)>0  and order_mainqt.zzfy in $dwdmStr and order_mainqt.state<>'作废订单' ",$conn);
...
//backend 单价为0不显示
$rsdd = mysql_query("select memo as dmemo,scqkbz ,ddh,khmc, ddate ,dje from  order_mainqt where ddate>='$d1 00:00:00' and ddate<='$d2 23:59:59' and order_mainqt.khmc like '%{$d3}%' and locate('$d4',order_mainqt.ddh)>0  and order_mainqt.zzfy in $dwdmStr and order_mainqt.state<>'作废订单' order by order_mainqt.ddate limit $startrow ,$pagenum ", $conn);
...
//                                if (!$zhrs || mysql_num_rows($zhrs) <= 0) continue;
                                ...
                                <tr style="height: 30px">
                                    ...
                                    <td align="center" colspan="7"><? echo $dd['dje']; ?></td>
                                </tr>
...
<?
//paging
$param = 'rq1='.$d1.'&rq2='.$d2.'&fkhmc='.$d3.'&fddh='.$d4;
